...
function App() {
  return (
    <div>
      <h1>Welcome to guarantyresources,</h1>
      <p>
These terms and conditions outline the rules and regulations for the use of guarantyresources’s website, located at guarantyresources.com. By accessing this website we assume you accept these terms and conditions. Do not continue to use guarantyresources if you do not agree to take all of the terms and conditions stated on this page.
...
Cookies
We employ the use of cookies. By accessing guarantyresources, you agreed to use cookies in agreement with the guarantyresources Privacy Policy.
...
Parts of this website may offer an opportunity for users to post and exchange opinions and information in certain areas of the website. Guarantyresources does not filter, edit, publish or review comments prior to their presence on the website. Comments do not reflect the views and opinions of guarantyresources, its agents and/or affiliates. Comments reflect the views and opinions of the persons who post such view and/or opinion. To the extent permitted by applicable laws, guarantyresources shall not be liable for the comments or for any liability, damages or expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the comments on this website.
